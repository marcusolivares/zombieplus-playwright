...
Check settings.json `env` block for:

| Env Variable | Flag if | Recommended |
|--------------|---------|-------------|
| CLAUDE_AUTOCOMPACT_PCT_OVERRIDE | Missing or > 80 | 75 |
| BASH_MAX_OUTPUT_LENGTH | At default (30-50K) | 150000 |
...
| Missing CLAUDE_AUTOCOMPACT_PCT_OVERRIDE env | -10 |
| Missing BASH_MAX_OUTPUT_LENGTH env | -5 |
